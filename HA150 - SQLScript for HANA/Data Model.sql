...
INSERT INTO Official VALUES ('P04','Ms D',,'A12','P09');
...
INSERT INTO Official VALUES ('P08','Ms H',,'A13','P09');
INSERT INTO Official VALUES ('P09','Mr I',,'A14',);
...
INSERT INTO Owner VALUES('H03','SAP AG',,'Walldorf');
INSERT INTO Owner VALUES('H04','HDM AG',,'Heidelberg');
INSERT INTO Owner VALUES('H05','Mr V','1952-04-21','Leimen');
INSERT INTO Owner VALUES('H06','Ms W','1957-06-01','Wiesloch');
INSERT INTO Owner VALUES('H07','IKEA',,'Walldorf');
...
INSERT INTO Car VALUES('F16',,'Opel','green','120',);
...
INSERT INTO Car VALUES('F20',,'Audi','green','184',);
...
CREATE COLUMN TABLE Contact(
  ...
  Owner VARCHAR(3),
  FOREIGN KEY(PersNumber) REFERENCES Offical(PNR) INITIALLY IMMEDIATE,
  FOREIGN KEY(Owner)      REFERENCES Owner(OwnerID) INITIALLY IMMEDIATE,
);
